...
- [2026-01-05 14:50] 優化一鍵每日更新輸出格式
- [2026-01-05 15:05] 修復 I/O on closed file 錯誤，建立 NullWriter 類別
- [2026-01-05 15:35] 深入分析 API 問題：
  - TPEx API 返回日期是 2026-01-02（非今日），API 更新較慢
  - TWSE MI_INDEX 正確返回今日日期
  - 程式邏輯正確，資料日期不符導致跳過
- [2026-01-05 15:40] 恢復簡潔輸出格式：
  - 使用 NullWriter 抑制子函數輸出
  - 保留步驟結果統計
  - 五~九步驟顯示 `[今日行情] ✓ (14時更新)` 格式
- [2026-01-05 16:20] 優化每日更新輸出顯示詳細統計：
  - 新增 `get_daily_stats` 輔助函數
  - 顯示各步驟的執行結果 (筆數、大盤狀態等)
  - 格式：`[今日行情] ✓ (14時更新) ✓大盤✓ TWSE 1062檔 / TPEx 871檔`
